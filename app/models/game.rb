class Game < ApplicationRecord
  ...
  # actually seeded here yet; the rest are listed ahead of having any
  ...
  # steam_app_ids match paradox-scores' Game::ALL (the canonical source).
  WIKI_ACHIEVEMENTS_URLS = {
    EU4_STEAM_APP_ID => "https://eu4.paradoxwikis.com/Achievements",
    529_340 => "https://vic3.paradoxwikis.com/Achievements", # Victoria 3
    ...
    3_450_310 => "https://eu5.paradoxwikis.com/Achievements" # Europa Universalis V
  }.freeze
